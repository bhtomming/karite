<form id="form" method="post" action="index.php?step=complete">
<div class="content">
	<h2>数据库信息请从空间商获取</h2>
	<table class="tb">
		<tr>
		...
		<tr>
			<td>数据库名</td>
			<td><input class="inp" id="dbname" name="dbname" type="text" value="dpcms" tips="请填写数据库名"></td>
		</tr>
		<tr>
			<td>表前辍</td>
			<td><input class="inp" id="dbpre" name="dbpre" type="text" value="dp_" tips="如安装多套dpcms，请修改"></td>
		</tr>
		<tr>
			<td>覆盖安装</td>
...
<div class="button"><input id="submit" type="submit" value="下一步" class="but grey" /><a href="index.php?step=check_env">上一步</a></div>
</form>
